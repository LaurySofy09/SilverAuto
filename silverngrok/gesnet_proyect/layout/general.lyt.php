...
<head>
	...
	<!-- Agrega este código en el encabezado de tu archivo HTML -->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" integrity="sha512-xxx..." crossorigin="anonymous" />
    ...
    <script type="text/javascript" src="web/assets/js/plugins/forms/validation/autoNumeric.js"></script>
	<!-- /theme JS files -->
</head>
...
<body class="sidebar-xs has-detached-right">
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="./?View=Inicio"><img src="web/assets/images/LOGO_silverf.png" alt="" style="width: 100px; height: 30px; margin-top: 0px;"></a>

			<ul class="nav navbar-nav visible-xs-block">
				<li><a data-toggle="collapse" data-target="#navbar-mobile"><i class="icon-lock2"></i></a></li>
				<li><a class="sidebar-mobile-main-toggle"><i></i></a></li>
			</ul>
		</div>

		<div class="navbar-collapse collapse" id="navbar-mobile">
			<ul class="nav navbar-nav">
				<li><a class="sidebar-control sidebar-main-toggle hidden-xs"><i></i></a></li>
			</ul>
