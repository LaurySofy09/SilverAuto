...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(105,10,'VENTAS (DETALLADAS) AL CONTADO DEL DIA '.strtoupper($dias[(int)date('w')])." ".strtoupper(date('d'))." DE ".strtoupper(
...
try {
    ...
    $pdf->Text(10,$get_Y + 20,'TOTAL DE ITBMS EN VENTAS : '.number_format($total_iva, 2, '.', ','));
