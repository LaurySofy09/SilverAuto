<?php
	...
	$pdf->AddPage();
		...
		$pdf->Text(13, $get_YC  + 13, 'INFORMACION DEL APARATO');
		$pdf->SetFont('Arial', '', 9.2);
		$pdf->Text(13, $get_YC  + 19, 'Placa: '.$Placa);
		$pdf->Text(13, $get_YC  + 25, 'Marca: '.$nombre_marca);
		$pdf->Text(13, $get_YC  + 31, 'Modelo: '.$modelo);
		$pdf->Text(13, $get_YC  + 37, 'Año: '.$AnioAuto);
		$pdf->SetFont('Arial', 'B', 9.2);
		$pdf->Text(9.5, $get_YC  + 44, 'AVERIA: ');
		...
		$pdf->MultiCell(55, 4.2, utf8_decode('Despues de dos meses no se aceptan reclamos por los articulos
