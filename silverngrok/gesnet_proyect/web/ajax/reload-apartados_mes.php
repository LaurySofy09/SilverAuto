<?php
  ...
  $count_Apartados = $objApartado->Count_Apartados('MES',$mes,'');
            ...
            <div class="panel-body">
              <table class="table datatable-basic table-xs table-hover">
                ...
                <tbody>
                  ...
                  <?php
                    $filas = $objApartado->Listar_Apartados('MES',$mes,'',1);
            ...
            <div class="panel-body">
              <table class="table datatable-basic table-xs table-hover">
                ...
                <tbody>
                  ...
                  <?php
                    $filas = $objApartado->Listar_Apartados('MES',$mes,'',0);
                    if (is_array($filas) || is_object($filas))
                    {
                    foreach ($filas as $row => $column)
                    {
            ...
            <div class="panel-body">
              <table class="table datatable-basic table-xs table-hover">
                ...
                <tbody>
                  ...
                  <?php
                    $filas = $objApartado->Listar_Apartados('MES',$mes,'',2);
                    if (is_array($filas) || is_object($filas))
                    {
                    foreach ($filas as $row => $column)
                    {
