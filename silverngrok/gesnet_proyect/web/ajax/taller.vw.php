                                          ...
                                          <legend class="text-semibold">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group"> 
                                                ...
                                                <!--  <div class="col-sm-6">
                                                        <label>Cliente <span class="text-danger">*</span></label>
                                                        <input type="text"  id="txtCliente" name="txtCliente" placeholder="Juán Pérez" class="form-control" style="text-transform:uppercase;"
                                                        onkeyup="javascript:this.value=this.value.toUpperCase();">
                                                  </div>-->
                                               ...
                                               <!-- <div class="col-sm-6">
                                                    ...
                                                    <input type="text"  id="txtCedula" name="txtCedula" placeholder="8-888-888" class="form-control" style="text-transform:uppercase;"
                                                    onkeyup="javascript:this.value=this.value.toUpperCase();">
                                                </div> -->
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                  ...
                                                  <div class="col-sm-4">
                                                     ...
                                                     <input type="text" id="txtModelo" name="txtModelo" placeholder="EJ. COROLLA"
                                                      class="form-control"  style="text-transform:uppercase;"
                                                     onkeyup="javascript:this.value=this.value.toUpperCase();">
                                                  </div>
                                                ...
                                                <div class="col-sm-4">
                                                     ...
                                                     <input type="text" id="txtAnio" name="txtAnio" placeholder="2015"
