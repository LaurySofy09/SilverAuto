...
function openCliente(action,idcliente,codigo_cliente,nombre_cliente,numero_nit,numero_nrc,direccion,numero_telefono,email,giro,limite_credito,estado,iddias)
 {
    ...
    $('#modal_iconified').on('shown.bs.modal', function () {
     ...
     $("#cbDias").val(iddias).trigger("change");
...
function enviar_frm()
{
  ...
  dataString+='&numero_nit='+numero_nit+'&email='+email+'&direccion='+direccion+'&limite_credito='+limite_credito+'&giro='+giro+'&iddias='+iddias;
