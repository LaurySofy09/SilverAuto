...
function newProveedor()
 {
    openProveedor('nuevo',null,null,null,null,null,null,null,null,null,null,null,null);
    $('#modal_iconified').modal('show');
 }
function openProveedor(action,idproveedor, codigo_proveedor, nombre_proveedor, numero_telefono, numero_nit, numero_nrc, nombre_contacto, telefono_contacto, estado, Correo, Direccion, Comentario)
 {
...
function enviar_frm()
{
  ...
  dataString+='&numero_nit='+numero_nit+'&numero_nrc='+numero_nrc+'&nombre_contacto='+nombre_contacto+'&telefono_contacto='+telefono_contacto+'&Correo='+Correo+'&Direccion='+Direccion+'&Comentario='+Comentario;
