			...
			<div class="panel panel-flat">
				<div class="breadcrumb-line">
					...
					<div class="panel-heading">
						<h5 class="panel-title">Proveedor / Empresa</h5>
								...
								<div class="alert alert-info alert-styled-left text-blue-800 content-group">
						           ...
						           <div class="form-group">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-12">
												<label>Proveedor / Empresa <span class="text-danger">*</span></label>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6" style="display: none;">
												<label>CIP <span class="text-danger">*</span></label>
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-sm-6">
												...
												<input type="text" id="txtCorreo" name="txtCorreo" placeholder="EJ. 051944039646"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
										</div>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-12">
												...
												<input type="text" id="txtDomicilio" name="txtDomicilio" placeholder="EJ. Casa/Apt, Calle, Barrio, Sector, Ciudad, Corregimiento, Distrito, Provincia/Estado, País"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
											...
											<div class="col-sm-6" style="display: none;">
												...
												<input type="text" id="txtTelefonoC" name="txtTelefonoC" placeholder="EJ. 054628824"
												 class="form-control" style="visible: false, text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-12">
												...
												<input type="text" id="txtComentario" name="txtComentario" placeholder="EJ. Comentarios..."
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
