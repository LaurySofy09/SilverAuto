						           ...
						           <div class="form-group">
									...
									<div class="form-group">
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<input type="text" id="txtGiro" name="txtGiro" placeholder="EJ. VENTA DE SUMINISTROS"
													 class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
												</div>
									 ...
									 <div class="form-group">
				                        <div class="row">
				                            <div class="col-sm-6">
				                                <label>Dias a pagar <span class="text-danger">*</span></label>
				                                <select  data-placeholder="Seleccione cantidad..." id="cbDias" name="cbDias"
				                                         class="select-search" style="text-transform:uppercase;"
				                                         onkeyup="javascript:this.value = this.value.toUpperCase();">
				                                        <?php
				                                        $filas = $objCliente->Listar_Dias();
				                                        if (is_array($filas) || is_object($filas)) {
				                                            foreach ($filas as $row => $column) {
				                                                ?>
				                                                <option value="<?php print ($column["iddias"]) ?>">
				                                                <?php print ($column["cantidad_dias"]) ?></option>
				                                                <?php
				                                            }
				                                        }
				                                        ?>
										...
										<div class="row">
											<div class="col-sm-12">
												<label>Direccion</label>
												 <textarea rows="2" class="form-control" placeholder="EJ. VIA ARGENTINA, CIUDAD DE PANAMA" id="txtDireccion" name="txtDireccion" value="" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
