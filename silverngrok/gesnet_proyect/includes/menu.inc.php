					...
					<?php  if($tipo_usuario == '1'){ ?> <!-- Admin -->
						<!-- Almacen -->
						<li>
							<a href="#"><i class="icon-box"></i> <span>Inventario</span></a>
							<ul>
								<li><a href="./?View=Categoria">Categoria</a></li>
								<li><a href="./?View=Presentacion">Modelo</a></li>
						...
						<li>
							...
							<ul>
								<li><a href="./?View=Proveedor">Proveedor / Empresa</a></li>
						...
						<li>
							...
							<ul>
								<li><a href="./?View=Caja">Abrir Caja</a></li>
								<li><a href="./?View=Historico-Factura">Historial de Facturas</a></li>
								<li><a href="./?View=POS&f=fact">Facturas</a></li>
								<li><a href="./?View=Historico-Factura">Historial de Facturas</a></li>
							</ul>
						</li>
						<!-- /Caja -->
						...
						<li>
							...
							<ul>
								...
								<li><a href="./?View=POS">Facturar</a></li>
					...
					<?php } elseif ($tipo_usuario == '2') { ?> <!-- Vendedor -->
						<!-- Cotizaciones -->
						<li>
							<a href="#"><i class="icon-file-spreadsheet"></i> <span>Cotizaciones</span></a>
							<ul>
						...
						<!-- /Ventas -->
					<?php } elseif ($tipo_usuario == '3') { ?> <!-- Cajero -->
						<!-- Caja -->
						<li>
							<a href="#"><i class="icon-cash3"></i> <span>Caja</span></a>
							<ul>
								<li><a href="./?View=Caja">Abrir Caja</a></li>
								<li><a href="./?View=Historico-Factura">Historial de Facturas</a></li>
								<li><a href="./?View=POS">Facturas</a></li>
								<li><a href="./?View=Historico-Factura">Historial de Facturas</a></li>
							</ul>
						</li>
						<!-- /Caja -->
					<?php } elseif ($tipo_usuario == '4') { ?> <!-- Tecnico -->
						<!-- Taller  --->
						<li>
							<a href="#"><i class="icon-hammer-wrench"></i> <span>Taller</span></a>
							<ul>
