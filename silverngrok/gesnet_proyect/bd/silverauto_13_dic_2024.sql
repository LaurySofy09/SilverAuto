...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_view_info_cotizacion` (IN `p_idcotizacion` INT(11))   BEGIN
	...
	IF  p_idcotizacion  = '' THEN
		...
		total_exento,retenido,total_descuento,total,empleado, 
                nombre_cliente, fecha_cotizacion, numero_cotizacion, cantidad, 
                precio_unitario, importe, nombre_producto, exento, descuento
...
(1, 'PR00000001', '1', '1', 'CASE TORRE A', 20.00, 40.00, 45.00, 30.00, 35.00, 30.00, 921, 10, 1, 1, 1, 1, 0, 1, 0, 'imgepd.jpg', 1),
(2, 'PR00000002', '2', '2', 'CASE TORRE 2', 20.00, 30.00, 32.00, 33.00, 35.00, 25.00, 939, 20, 1, 2, 1, 1, 1, 1, 0, '', 1),
...
--
ALTER TABLE `historial`
  MODIFY `idhistorial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
