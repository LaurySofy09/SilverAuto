...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-05-2022 a las 05:02:51
...
-- Procedimientos
--
CREATE  PROCEDURE `sp_abrir_caja` (IN `p_monto_apertura` DECIMAL(13,2))   BEGIN
...
CREATE  PROCEDURE `sp_cerrar_caja` (IN `p_monto_cierre` DECIMAL(13,2))   BEGIN
...
CREATE  PROCEDURE `sp_descontar_perecedero` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(13,2), IN `p_fecha_vencimiento` DATE)   BEGIN
...
CREATE  PROCEDURE `sp_insert_abono` (IN `p_idcredito` INT(11), IN `p_monto_abono` DECIMAL(13,2), IN `p_idusuario` INT(11))   BEGIN
DECLARE p_codigo_credito varchar(175);
DECLARE p_monto_restante DECIMAL(13,2);
...
CREATE  PROCEDURE `sp_insert_caja_apartado` (IN `p_monto_movimiento` DECIMAL(13,2))   BEGIN
...
CREATE  PROCEDURE `sp_insert_caja_movimiento` (IN `p_tipo_movimiento` TINYINT(1), IN `p_monto_movimiento` DECIMAL(13,2), IN `p_descripcion_movimiento` VARCHAR(80))   BEGIN
    DECLARE p_idcaja int(11);
    DECLARE p_tipo_comprobante tinyint(1);
    DECLARE p_numero_comprobante int(11);
...
CREATE  PROCEDURE `sp_insert_caja_venta` (IN `p_monto_movimiento` DECIMAL(13,2))   BEGIN
...
CREATE  PROCEDURE `sp_insert_cliente` (IN `p_nombre_cliente` VARCHAR(150), IN `p_numero_nit` VARCHAR(70), IN `p_numero_nrc` VARCHAR(45), IN `p_direccion_cliente` VARCHAR(100), IN `p_numero_telefono` VARCHAR(70), IN `p_email` VARCHAR(80), IN `p_giro` VARCHAR(80), IN `p_limite_credito` DECIMAL(13,2))   BEGIN
...
CREATE  PROCEDURE `sp_insert_credito_venta` (IN `p_monto_credito` DECIMAL(13,2), IN `p_idcliente` INT(11))   BEGIN
...
CREATE  PROCEDURE `sp_insert_detalleapartado` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(13,2), IN `p_precio_unitario` DECIMAL(13,2), IN `p_exento` DECIMAL(13,2), IN `p_descuento` DECIMAL(13,2), IN `p_fecha_vence` DATE, IN `p_importe` DECIMAL(13,2))   BEGIN
...
CREATE  PROCEDURE `sp_insert_detallecompra` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(13,2), IN `p_precio_unitario` DECIMAL(13,2), IN `p_exento` DECIMAL(13,2), IN `p_fecha_vencimiento` DATE, IN `p_importe` DECIMAL(13,2))   BEGIN
...
CREATE  PROCEDURE `sp_insert_detallecotizacion` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(13,2), IN `p_disponible` TINYINT(1), IN `p_precio_unitario` DECIMAL(13,2), IN `p_exento` DECIMAL(13,2), IN `p_descuento` DECIMAL(13,2), IN `p_importe` DECIMAL(13,2))   BEGIN
...
CREATE  PROCEDURE `sp_insert_detalleventa` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(13,2), IN `p_precio_unitario` DECIMAL(13,2), IN `p_exento` DECIMAL(13,2), IN `p_descuento` DECIMAL(13,2), IN `p_fecha_vence` DATE, IN `p_importe` DECIMAL(13,2))   BEGIN
...
CREATE  PROCEDURE `sp_insert_diagnostico` (IN `p_idorden` INT(11), IN `p_diagnostico` VARCHAR(200), IN `p_estado_aparato` VARCHAR(200), IN `p_repuestos` DECIMAL(13,2), IN `p_mano_obra` DECIMAL(13,2), IN `p_fecha_alta` DATETIME, IN `p_fecha_retiro` DATETIME, IN `p_ubicacion` VARCHAR(150), IN `p_parcial_pagar` DECIMAL(13,2))   BEGIN
	UPDATE `ordentaller`
...
CREATE  PROCEDURE `sp_insert_empleado` (IN `p_nombre_empleado` VARCHAR(90), IN `p_apellido_empleado` VARCHAR(90), IN `p_telefono_empleado` VARCHAR(70), IN `p_email_empleado` VARCHAR(80), IN `p_image` VARCHAR(170))   BEGIN
...
CREATE  PROCEDURE `sp_insert_entrada` (IN `p_descripcion_entrada` VARCHAR(150), IN `p_cantidad_entrada` DECIMAL(13,2), IN `p_idproducto` INT(11))   BEGIN
...
CREATE  PROCEDURE `sp_insert_parametro` (IN `p_nombre_empresa` VARCHAR(150), IN `p_propietario` VARCHAR(150), IN `p_numero_nit` VARCHAR(70), IN `p_numero_nrc` VARCHAR(70), IN `p_porcentaje_iva` DECIMAL(13,2), IN `p_porcentaje_retencion` DECIMAL(13,2), IN `p_monto_retencion` DECIMAL(13,2), IN `p_direccion_empresa` VARCHAR(200), IN `p_idcurrency` INT(11))   BEGIN
...
CREATE  PROCEDURE `sp_insert_perecedero` (IN `p_fecha_vencimiento` DATE, IN `p_cantidad_perecedero` DECIMAL(13,2), IN `p_idproducto` INT(11))   BEGIN
...
CREATE  PROCEDURE `sp_insert_producto` (IN `p_codigo_barra` VARCHAR(200), IN `p_nombre_producto` VARCHAR(175), IN `p_precio_compra` DECIMAL(13,2), IN `p_precio_venta` DECIMAL(13,2), IN `p_precio_venta_mayoreo` DECIMAL(13,2), IN `p_stock` DECIMAL(13,2), IN `p_stock_min` DECIMAL(13,2), IN `p_idcategoria` INT(11), IN `p_idmarca` INT(11), IN `p_idpresentacion` INT(11), IN `p_exento` TINYINT(1), IN `p_inventariable` TINYINT(1), IN `p_perecedero` TINYINT(1), IN `p_image` VARCHAR(170))   BEGIN
	...
	IF (p_inventariable = 1) THEN
	 ...
	 IF NOT EXISTS (SELECT * FROM `producto` WHERE `nombre_producto` = p_nombre_producto) THEN
		...
		p_exento, p_inventariable, p_perecedero, p_image);
	 END IF;
...
CREATE  PROCEDURE `sp_insert_salida` (IN `p_descripcion_salida` VARCHAR(150), IN `p_cantidad_salida` DECIMAL(13,2), IN `p_idproducto` INT(11))   BEGIN
...
CREATE  PROCEDURE `sp_insert_usuario` (IN `p_usuario` VARCHAR(70), IN `p_contrasena` VARCHAR(180), IN `p_tipo_usuario` TINYINT(1), IN `p_idempleado` INT(11))   BEGIN
...
CREATE  PROCEDURE `sp_login_usuario` (IN `p_usuario` VARCHAR(70), IN `p_contrasena` VARCHAR(180))   BEGIN
...
CREATE  PROCEDURE `sp_update_abono` (IN `p_idabono` INT(11), IN `p_fecha_abono` DATETIME, IN `p_monto_abono` DECIMAL(13,2))   BEGIN
UPDATE `abono`
...
CREATE  PROCEDURE `sp_update_credito` (IN `p_idcredito` INT(11), IN `p_nombre_credito` VARCHAR(120), IN `p_fecha_credito` DATETIME, IN `p_monto_credito` DECIMAL(13,2), IN `p_monto_abonado` DECIMAL(13,2), IN `p_monto_restante` DECIMAL(13,2), IN `p_estado` TINYINT(1))   BEGIN
UPDATE `credito`
...
CREATE  PROCEDURE `sp_update_empleado` (IN `p_idempleado` INT(11), IN `p_nombre_empleado` VARCHAR(90), IN `p_apellido_empleado` VARCHAR(90), IN `p_telefono_empleado` VARCHAR(70), IN `p_email_empleado` VARCHAR(80), IN `p_estado` TINYINT(1), IN `p_image` VARCHAR(170))   BEGIN
UPDATE `empleado`
...
CREATE  PROCEDURE `sp_update_monto_inicial` (IN `p_monto_apertura` DECIMAL(13,2))   BEGIN
...
CREATE  PROCEDURE `sp_update_parametro` (IN `p_idparametro` INT(11), IN `p_nombre_empresa` VARCHAR(150), IN `p_propietario` VARCHAR(150), IN `p_numero_nit` VARCHAR(70), IN `p_numero_nrc` VARCHAR(70), IN `p_porcentaje_iva` DECIMAL(13,2), IN `p_porcentaje_retencion` DECIMAL(13,2), IN `p_monto_retencion` DECIMAL(13,2), IN `p_direccion_empresa` VARCHAR(200), IN `p_idcurrency` INT(11))   BEGIN
UPDATE `parametro`
...
CREATE  PROCEDURE `sp_update_perecedero` (IN `p_fecha_vencimiento` DATE, IN `p_cantidad_perecedero` DECIMAL(13,2), IN `p_idproducto` INT(11))   BEGIN
  UPDATE `perecedero` SET
...
CREATE  PROCEDURE `sp_update_producto` (IN `p_idproducto` INT(11), IN `p_codigo_barra` VARCHAR(200), IN `p_nombre_producto` VARCHAR(175), IN `p_precio_compra` DECIMAL(13,2), IN `p_precio_venta` DECIMAL(13,2), IN `p_precio_venta_mayoreo` DECIMAL(13,2), IN `p_stock_min` DECIMAL(13,2), IN `p_idcategoria` INT(11), IN `p_idmarca` INT(11), IN `p_idpresentacion` INT(11), IN `p_estado` TINYINT(1), IN `p_exento` TINYINT(1), IN `p_inventariable` TINYINT(1), IN `p_perecedero` TINYINT(1), IN `p_image` VARCHAR(170))   BEGIN
  IF (p_inventariable = 0) THEN
		UPDATE `producto`
		...
		`exento` = p_exento, `inventariable` = p_inventariable, `perecedero` = p_perecedero, `imagen` = p_image
		WHERE `idproducto` = p_idproducto;
	ELSE
		UPDATE `producto`
		SET `codigo_barra` = p_codigo_barra, `nombre_producto` = p_nombre_producto, `precio_compra` = p_precio_compra,
...
CREATE  PROCEDURE `sp_update_usuario` (IN `p_idusuario` INT(11), IN `p_usuario` VARCHAR(70), IN `p_contrasena` VARCHAR(180), IN `p_tipo_usuario` TINYINT(1), IN `p_estado` TINYINT(1), IN `p_idempleado` INT(11))   BEGIN
UPDATE `usuario`
...
CREATE  PROCEDURE `sp_view_cotizacion` (`p_fecha` DATE, `p_fecha2` DATE)   BEGIN
...
(1, '2022-04-09 00:35:38', '0.01', '0.00', NULL, 1),
(2, '2022-04-24 22:13:11', '0.01', '0.00', NULL, 1),
(3, '2022-04-25 00:21:52', '0.01', '0.00', NULL, 1),
(4, '2022-05-02 09:35:06', '1.00', '0.00', NULL, 1),
(5, '2022-05-04 21:41:33', '1.00', '0.00', NULL, 1);
...
(2, 1, '240.00', 'POR VENTA TICKET # 2', '2022-04-24'),
(2, 1, '240.00', 'POR VENTA TICKET # 3', '2022-04-24'),
(2, 1, '270.00', 'POR VENTA TICKET # 4', '2022-04-24'),
(2, 1, '302.00', 'POR VENTA TICKET # 5', '2022-04-24'),
(2, 1, '286.00', 'POR VENTA TICKET # 6', '2022-04-24'),
(4, 1, '1500.00', 'POR VENTA TICKET # 7', '2022-05-02'),
(4, 1, '1500.00', 'POR VENTA FACTURA # 2', '2022-05-02'),
(4, 1, '150.00', 'POR VENTA FACTURA # 3', '2022-05-02'),
(4, 1, '1500.00', 'POR VENTA TICKET # 8', '2022-05-02'),
(4, 1, '1650.00', 'POR VENTA TICKET # 9', '2022-05-02'),
(4, 1, '1500.00', 'POR VENTA TICKET # 10', '2022-05-02'),
(4, 1, '1500.00', 'POR VENTA TICKET # 11', '2022-05-02');
...
(1, 'CL00000001', 'JUAN CARRASCO', '45456567', '456456456', 'CALLE JIRON', '985757', 'micorreo@gmail.com', 'VENTA SUMINISTROS', '40000.00', 1);
...
(1, 13, 'CRED00000001', 'POR VENTA # V00000013', '2022-05-04 21:41:55', '16.00', '0.00', '16.00', 0, 1),
(2, 14, 'CRED00000002', 'POR VENTA # V00000014', '2022-05-04 21:43:01', '32.00', '0.00', '32.00', 0, 1);
...
(1, 1, '2.00', '120.00', NULL, '0.00', '0.00', '240.00'),
(2, 1, '2.00', '120.00', NULL, '0.00', '0.00', '240.00'),
(3, 2, '1.00', '150.00', NULL, '0.00', '0.00', '150.00'),
(3, 1, '1.00', '120.00', NULL, '0.00', '0.00', '120.00'),
(4, 3, '2.00', '16.00', NULL, '0.00', '0.00', '32.00'),
(4, 2, '1.00', '150.00', NULL, '0.00', '0.00', '150.00'),
(4, 1, '1.00', '120.00', NULL, '0.00', '0.00', '120.00'),
(5, 1, '1.00', '120.00', NULL, '0.00', '0.00', '120.00'),
(5, 3, '1.00', '16.00', NULL, '0.00', '0.00', '16.00'),
(5, 2, '1.00', '150.00', NULL, '0.00', '0.00', '150.00'),
(6, 1, '1.00', '1500.00', NULL, '0.00', '0.00', '1500.00'),
(7, 1, '1.00', '1500.00', NULL, '0.00', '0.00', '1500.00'),
(8, 2, '1.00', '150.00', NULL, '0.00', '0.00', '150.00'),
(9, 1, '1.00', '1500.00', NULL, '0.00', '0.00', '1500.00'),
(10, 2, '1.00', '150.00', NULL, '0.00', '0.00', '150.00'),
(10, 1, '1.00', '1500.00', NULL, '0.00', '0.00', '1500.00'),
(11, 1, '1.00', '1500.00', NULL, '0.00', '0.00', '1500.00'),
(12, 1, '1.00', '1500.00', NULL, '0.00', '0.00', '1500.00'),
(13, 3, '1.00', '16.00', NULL, '0.00', '0.00', '16.00'),
(14, 3, '2.00', '16.00', NULL, '0.00', '0.00', '32.00');
...
(1, 'EM00000001', 'EMPLEADO', 'TIENDA', '985444754', 'tienda@empresa.com', 1, NULL);
...
CREATE TABLE `entrada` (
  ...
  `cantidad_entrada` decimal(13,2) NOT NULL,
...
(62, '2022-04', '2022-04-10', 'INVENTARIO INICIAL', '200.00', '80.00', '16000.00', 1, NULL, NULL),
(63, '2022-04', '2022-04-24', 'INVENTARIO INICIAL', '12.00', '100.00', '1200.00', 2, NULL, NULL),
(64, '2022-04', '2022-04-24', 'INVENTARIO INICIAL', '100.00', '12.00', '1200.00', 3, NULL, NULL),
(65, '2022-05', '2022-05-04', 'POR AJUSTE DE INVENTARIO', '100.00', '1200.00', '120000.00', 1, NULL, NULL),
(66, '2022-05', '2022-05-04', 'INVENTARIO INICIAL', '34.00', '34.00', '1156.00', 4, NULL, NULL);
...
CREATE TABLE `inventario` (
  ...
  `entradas` decimal(13,2) DEFAULT NULL,
  `salidas` decimal(13,2) DEFAULT NULL,
...
('2022-04', '2022-04-01', '2022-04-30', '200.00', '200.00', '7.00', '193.00', 1, 1),
('2022-04', '2022-04-01', '2022-04-30', '12.00', '12.00', '3.00', '9.00', 1, 2),
('2022-04', '2022-04-01', '2022-04-30', '100.00', '100.00', '3.00', '97.00', 1, 3),
('2022-05', '2022-05-01', '2022-05-31', '193.00', '100.00', '7.00', '286.00', 1, 1),
('2022-05', '2022-05-01', '2022-05-31', '9.00', '0.00', '2.00', '7.00', 1, 2),
('2022-05', '2022-05-01', '2022-05-31', '97.00', '0.00', '3.00', '94.00', 1, 3),
('2022-05', '2022-05-01', '2022-05-31', '34.00', '34.00', '0.00', '34.00', 1, 4);
...
CREATE TABLE `ordentaller` (
  ...
  `deposito_revision` decimal(13,2) NOT NULL DEFAULT 0.00,
  `deposito_reparacion` decimal(13,2) DEFAULT 0.00,
  `diagnostico` varchar(200) NOT NULL,
  `estado_aparato` varchar(200) NOT NULL,
  `repuestos` decimal(13,2) NOT NULL DEFAULT 0.00,
...
(1, '00000001', '2022-05-04 02:04:50', 1, 'LAPTO c', 'SATELITTE', 1, '780760670', 1, 'TECLADO ZZ', 'CAMBIO', '300.00', '100.00', 'NECESITA CAMBIOS', 'REPARADO CON EXITO', '300.00', '150.00', '2022-05-04 16:14:45', '2022-05-03 16:14:47', 'LIMA', '50.00'),
(2, '00000002', '2022-05-03 17:19:12', 1, 'LAPTO', 'SATELITTE', 1, '780760670', 1, 'TECLADO CCCCCC', 'CAMBIO XC', '300.00', '100.00', '', '', '0.00', '0.00', NULL, NULL, NULL, '50.00'),
(3, '00000003', '2022-05-03 17:19:46', 1, 'LAPTO', 'SATELITTE', 1, '780760670', 1, 'TECLADO AZUL', 'CAMBIO', '300.00', '100.00', '', '', '0.00', '0.00', NULL, NULL, NULL, '50.00'),
(4, '00000004', '2022-05-03 17:20:27', 1, 'LAPTO', 'SATELITTE', 1, '780760670', 1, 'TECLADO RAJADO', 'CAMBIO', '300.00', '100.00', '', '', '0.00', '0.00', NULL, NULL, NULL, '50.00');
...
(1, 'LA TIENDA', 'NOMBRE TIENDA', '88546478', '10885464786', '18.00', '0.00', '0.00', 'CALLE LAS FLORES 2451, AREQUIPA - PERU', NULL, 7);
...
CREATE TABLE `producto` (
  ...
  `stock` decimal(13,2) NOT NULL DEFAULT 0.00,
  `stock_min` decimal(13,2) NOT NULL DEFAULT 1.00,
  `idcategoria` int(11) NOT NULL,
...
INSERT INTO `producto` (`idproducto`, `codigo_interno`, `codigo_barra`, `nombre_producto`, `precio_compra`, `precio_venta`, `precio_venta_mayoreo`, `stock`, `stock_min`, `idcategoria`, `idmarca`, `idpresentacion`, `estado`, `exento`, `inventariable`, `perecedero`, `imagen`) VALUES
(1, 'PR00000001', '', 'MOUSE INALAMBRICO RIZEN 2022 GOLDEN HD', '1200.00', '1500.00', '1400.00', '286.00', '2.00', 1, 1, 1, 1, 0, 1, 0, 'mouse-hp-gaming-m150.jpg'),
(2, 'PR00000002', '', 'TECLADO SAMSUNG', '100.00', '150.00', '130.00', '7.00', '2.00', 1, 1, 1, 1, 0, 1, 0, ''),
(3, 'PR00000003', '', 'MONITOR GAMA ALTA NOBILIA FULL HD 2022 HACEY', '12.00', '16.00', '14.00', '94.00', '4.00', 1, 1, 1, 1, 0, 1, 0, ''),
(4, 'PR00000004', '', 'PIÑON', '34.00', '34.00', '21.00', '34.00', '2.00', 1, 1, 1, 1, 0, 1, 0, '');
...
CREATE TABLE `salida` (
  ...
  `cantidad_salida` decimal(13,2) NOT NULL,
...
(1, '2022-04', '2022-04-24', 'POR VENTA TICKET # 2', '2.00', '80.00', '160.00', 1, 1, NULL),
(2, '2022-04', '2022-04-24', 'POR VENTA TICKET # 3', '2.00', '80.00', '160.00', 1, 2, NULL),
(3, '2022-04', '2022-04-24', 'POR VENTA TICKET # 4', '1.00', '100.00', '100.00', 2, 3, NULL),
(4, '2022-04', '2022-04-24', 'POR VENTA TICKET # 4', '1.00', '80.00', '80.00', 1, 3, NULL),
(5, '2022-04', '2022-04-24', 'POR VENTA TICKET # 5', '2.00', '12.00', '24.00', 3, 4, NULL),
(6, '2022-04', '2022-04-24', 'POR VENTA TICKET # 5', '1.00', '100.00', '100.00', 2, 4, NULL),
(7, '2022-04', '2022-04-24', 'POR VENTA TICKET # 5', '1.00', '80.00', '80.00', 1, 4, NULL),
(8, '2022-04', '2022-04-24', 'POR VENTA TICKET # 6', '1.00', '80.00', '80.00', 1, 5, NULL),
(9, '2022-04', '2022-04-24', 'POR VENTA TICKET # 6', '1.00', '12.00', '12.00', 3, 5, NULL),
(10, '2022-04', '2022-04-24', 'POR VENTA TICKET # 6', '1.00', '100.00', '100.00', 2, 5, NULL),
(11, '2022-05', '2022-05-02', 'POR VENTA TICKET # 7', '1.00', '1200.00', '1200.00', 1, 6, NULL),
(12, '2022-05', '2022-05-02', 'POR VENTA FACTURA # 2', '1.00', '1200.00', '1200.00', 1, 7, NULL),
(13, '2022-05', '2022-05-02', 'POR VENTA FACTURA # 3', '1.00', '100.00', '100.00', 2, 8, NULL),
(14, '2022-05', '2022-05-02', 'POR VENTA FACTURA # 3', '1.00', '1200.00', '1200.00', 1, 8, NULL),
(15, '2022-05', '2022-05-02', 'POR VENTA TICKET # 8', '1.00', '1200.00', '1200.00', 1, 9, NULL),
(16, '2022-05', '2022-05-02', 'POR VENTA TICKET # 9', '1.00', '100.00', '100.00', 2, 10, NULL),
(17, '2022-05', '2022-05-02', 'POR VENTA TICKET # 9', '1.00', '1200.00', '1200.00', 1, 10, NULL),
(18, '2022-05', '2022-05-02', 'POR VENTA TICKET # 10', '1.00', '1200.00', '1200.00', 1, 11, NULL),
(19, '2022-05', '2022-05-02', 'POR VENTA TICKET # 11', '1.00', '1200.00', '1200.00', 1, 12, NULL),
(20, '2022-05', '2022-05-04', 'POR VENTA TICKET # 12', '1.00', '12.00', '12.00', 3, 13, NULL),
(21, '2022-05', '2022-05-04', 'POR VENTA TICKET # 13', '2.00', '12.00', '24.00', 3, 14, NULL);
...
(1, '2017-11-28 10:56:11', '20172811', '14541474584', 1, 5000, 1, 4987),
(2, '2017-11-28 10:56:11', '1214584575', '11545887965', 1, 5000, 2, 4997),
(3, '2017-11-28 10:56:11', '15415421542', '6554512412', 1, 5000, 3, 4999);
...
(1, 'V00000001', '2022-04-24 22:16:40', 'EFECTIVO', 2, 1, '203.39', '36.61', '0.00', '0.00', '0.00', '240.00', 'Doscientos cuarenta 00/100 USD', '300.00', '0.00', '', '', '60.00', 1, 1, 1),
(2, 'V00000002', '2022-04-24 22:30:58', 'EFECTIVO', 3, 1, '203.39', '36.61', '0.00', '0.00', '0.00', '240.00', 'Doscientos cuarenta 00/100 USD', '300.00', '0.00', '', '', '60.00', 1, 1, 1),
(3, 'V00000003', '2022-04-24 23:04:10', 'EFECTIVO', 4, 1, '228.81', '41.19', '0.00', '0.00', '0.00', '270.00', 'Doscientos setenta 00/100 USD', '400.00', '0.00', '', '', '130.00', 1, 1, 1),
(4, 'V00000004', '2022-04-24 23:31:55', 'EFECTIVO', 5, 1, '255.93', '46.07', '0.00', '0.00', '0.00', '302.00', 'Trescientos dos 00/100 USD', '400.00', '0.00', '', '', '98.00', 1, 1, 1),
(5, 'V00000005', '2022-04-24 23:34:20', 'EFECTIVO', 6, 1, '242.37', '43.63', '0.00', '0.00', '0.00', '286.00', 'Doscientos ochenta y seis 00/100 USD', '400.00', '0.00', '', '', '114.00', 1, 1, 1),
(6, 'V00000006', '2022-05-02 09:35:38', 'EFECTIVO', 7, 1, '1271.19', '228.81', '0.00', '0.00', '0.00', '1500.00', 'Mil quinientos 00/100 USD', '2000.00', '0.00', '', '', '500.00', 1, 1, 1),
(7, 'V00000007', '2022-05-02 09:44:12', 'EFECTIVO', 2, 2, '1271.19', '228.81', '0.00', '0.00', '0.00', '1500.00', 'Mil quinientos 00/100 USD', '2000.00', '0.00', '', '', '500.00', 1, 1, 1),
(8, 'V00000008', '2022-05-02 09:44:44', 'EFECTIVO', 3, 2, '127.12', '22.88', '0.00', '0.00', '0.00', '150.00', 'Ciento cincuenta 00/100 USD', '200.00', '0.00', '', '', '50.00', 1, 1, 1),
(9, 'V00000009', '2022-05-02 09:58:12', 'EFECTIVO', 8, 1, '1271.19', '228.81', '0.00', '0.00', '0.00', '1500.00', 'Mil quinientos 00/100 USD', '2000.00', '0.00', '', '', '500.00', 1, 1, 1),
(10, 'V00000010', '2022-05-02 10:03:46', 'EFECTIVO', 9, 1, '1398.31', '251.69', '0.00', '0.00', '0.00', '1650.00', 'Mil seiscientos cincuenta 00/100 USD', '2000.00', '0.00', '', '', '350.00', 1, 1, 1),
(11, 'V00000011', '2022-05-02 10:45:28', 'EFECTIVO', 10, 1, '1271.19', '228.81', '0.00', '0.00', '0.00', '1500.00', 'hola', '2000.00', '0.00', '', '', '500.00', 1, 1, 1),
(12, 'V00000012', '2022-05-02 11:51:12', 'EFECTIVO', 11, 1, '1271.19', '228.81', '0.00', '0.00', '0.00', '1500.00', 'Mil quinientos 00/100 USD', '2000.00', '0.00', '', '', '500.00', 1, 1, 1),
(13, 'V00000013', '2022-05-04 21:41:55', 'EFECTIVO', 12, 1, '13.56', '2.44', '0.00', '0.00', '0.00', '16.00', 'Cientos dieciseis 00/100 USD', '0.00', '0.00', NULL, '0.00', '0.00', 2, 1, 1),
(14, 'V00000014', '2022-05-04 21:43:01', 'EFECTIVO', 13, 1, '27.12', '4.88', '0.00', '0.00', '0.00', '32.00', 'Cientos treinta y dos 00/100 USD', '0.00', '0.00', NULL, '0.00', '0.00', 2, 1, 1);
...
,`entradas` decimal(13,2)
,`salidas` decimal(13,2)
...
,`deposito_revision` decimal(13,2)
,`deposito_reparacion` decimal(13,2)
,`diagnostico` varchar(200)
,`estado_aparato` varchar(200)
,`repuestos` decimal(13,2)
...
--
ALTER TABLE `entrada`
  MODIFY `identrada` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
