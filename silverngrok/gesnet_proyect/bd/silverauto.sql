...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-12-2024 a las 22:15:15
...
(34, '2024-11-26 14:45:39', 1000.00, 0.00, NULL, 1),
(35, '2024-12-16 09:36:34', 1000.00, 0.00, NULL, 1);
...
(7, 'COTI00000007', '2024-12-16 09:38:25', 'TOMAS CASTRO', 'AL CONTADO', 'INMEDIATA', 125.80, 4.19, 4.61, 0.00, 0.20, 129.99, 'Ciento veintinueve 99/100 USD', 1, 1, NULL),
(8, 'COTI00000008', '2024-12-16 15:23:37', 'TOMAS CASTRO', 'AL CONTADO', 'INMEDIATA', 125.80, 4.19, 4.61, 0.00, 0.20, 129.99, 'Ciento veintinueve 99/100 USD', 1, 1, NULL),
(9, 'COTI00000009', '2024-12-16 15:51:48', 'TOMAS CASTRO', 'AL CONTADO', 'INMEDIATA', 125.80, 4.19, 4.61, 0.00, 0.20, 129.99, 'Ciento veintinueve 99/100 USD', 1, 1, NULL);
...
(8, 1, 2, 0, 30.00, 0.00, 0.05, 60.00),
(8, 2, 2, 0, 33.00, 1.00, 0.05, 66.00),
(9, 1, 2, 0, 30.00, 0.00, 0.05, 60.00),
(9, 2, 2, 0, 33.00, 1.00, 0.05, 66.00);
...
--
-- Estructura de tabla para la tabla `detalle_ordentaller`
--
...
--
-- Volcado de datos para la tabla `detalle_ordentaller`
--
...
('2024-12', '2024-12-01', '2024-12-31', 926.00, 0, 0, 926.00, 1, 1),
('2024-12', '2024-12-01', '2024-12-31', 943.00, 0, 0, 943.00, 1, 2),
...
(1, 'PR00000001', '1', '1', 'CASE TORRE A', 20.00, 40.00, 45.00, 30.00, 35.00, 30.00, 926, 10, 1, 1, 1, 1, 0, 1, 0, 'imgepd.jpg', 1),
(2, 'PR00000002', '2', '2', 'CASE TORRE 2', 20.00, 30.00, 32.00, 33.00, 35.00, 25.00, 943, 20, 1, 2, 1, 1, 1, 1, 0, '', 1),
(3, 'PR00000003', '3', '3', 'CASE TORRE C', 49.99, 45.00, 40.00, 30.00, 0.00, 20.00, 20, 5, 1, 3, 1, 1, 0, 1, 0, '', 1);
...
(1, '2024-07-04 10:52:59', '1', '1', 1, 1000, 1, 922),
...
(79, 'V00000079', '2024-11-20 10:33:53', 'EFECTIVO', 77, 1, 40.00, 2.80, 0.00, 0.00, 0.00, 42.80, 'Cientos cuarenta y dos 80/100 USD', 0.00, 0.00, '', '', 0.00, 1, 1, 1, NULL, NULL, NULL, 1),
(80, 'V00000080', '2024-11-20 10:34:53', 'EFECTIVO', 78, 1, 30.00, 2.10, 0.00, 0.00, 0.00, 32.10, 'Cientos treinta y dos 10/100 USD', 0.00, 0.00, '', '', 0.00, 1, 1, 1, NULL, NULL, NULL, 1);
...
--
-- Estructura Stand-in para la vista `view_historia`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `view_historial`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura para la vista `view_historia`
--
...
--
-- Estructura para la vista `view_historial`
--
...
--
-- Indices de la tabla `detalle_ordentaller`
--
...
--
-- AUTO_INCREMENT de la tabla `detalle_ordentaller`
--
ALTER TABLE `detalle_ordentaller`
...
--
ALTER TABLE `historial`
  MODIFY `idhistorial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=117;
...
--
ALTER TABLE `salida`
  MODIFY `idsalida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;
